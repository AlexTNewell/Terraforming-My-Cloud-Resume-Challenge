...
import './dockerised-javascript-app.css'

const DockerisedJavascriptApp = (props) => {
  return (
    <div className="dockerised-javascript-app-container">
      <Helmet>
        <title>Dockerised-Javascript-App - Portfolio Page</title>
        <meta
          property="og:title"
          content="Dockerised-Javascript-App - Portfolio Page"
        />
      </Helmet>
      <div className="dockerised-javascript-app-container1">
        <div className="dockerised-javascript-app-container2">
          <h1 className="dockerised-javascript-app-text">
        ...
        <a
          ...
          className="dockerised-javascript-app-link"
        >
          <img
            alt="image"
            src="/github-200h.png"
            className="dockerised-javascript-app-image"
          />
        </a>
      </div>
      <h2 className="dockerised-javascript-app-text01">Using Terraform</h2>
      <span className="dockerised-javascript-app-text02">
        <span>
        ...
        <br></br>
        <br></br>
        <span className="dockerised-javascript-app-text10">
          Frontend: Javascript, HTML, CSS
        </span>
        <br className="dockerised-javascript-app-text11"></br>
        <span className="dockerised-javascript-app-text12">
          Backend: Node.js, Python
        </span>
        <br className="dockerised-javascript-app-text13"></br>
        <span className="dockerised-javascript-app-text14">
          Database: DynamoDB / noSQL
        </span>
        <br className="dockerised-javascript-app-text15"></br>
        <span className="dockerised-javascript-app-text16">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer noopener"
          className="dockerised-javascript-app-link1"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer noopener"
          className="dockerised-javascript-app-link2"
        >
        ...
        <br></br>
        <br></br>
        <span className="dockerised-javascript-app-text53">Tech Stack:</span>
        <br></br>
        <span>
...
export default DockerisedJavascriptApp
