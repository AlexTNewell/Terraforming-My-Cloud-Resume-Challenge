...
import './crc-terraform.css'

const CRCTerraform = (props) => {
  return (
    <div className="crc-terraform-container">
      <Helmet>
        <title>CRC-Terraform - Portfolio Page</title>
        <meta property="og:title" content="CRC-Terraform - Portfolio Page" />
      </Helmet>
      <div className="crc-terraform-container1">
        <div className="crc-terraform-container2">
          <h1 className="crc-terraform-text">Cloud Resume Challenge</h1>
        </div>
        <a
          href="https://github.com/AlexTNewell/Cloud-Resume-Challenge-CloudFormation"
          target="_blank"
          rel="noreferrer noopener"
          className="crc-terraform-link"
        >
          <img
            alt="image"
            src="/github-200h.png"
            className="crc-terraform-image"
          />
        </a>
      </div>
      <h2 className="crc-terraform-text01">Using Terraform</h2>
      <span className="crc-terraform-text02">
        <span>
        ...
        <br></br>
        <br></br>
        <span className="crc-terraform-text10">
          Frontend: Javascript, HTML, CSS
        </span>
        <br className="crc-terraform-text11"></br>
        <span className="crc-terraform-text12">Backend: Node.js, Python</span>
        <br className="crc-terraform-text13"></br>
        <span className="crc-terraform-text14">Database: DynamoDB / noSQL</span>
        <br className="crc-terraform-text15"></br>
        <span className="crc-terraform-text16">Deployment: GitHub Actions</span>
        <br></br>
        <br></br>
        <span>The code: </span>
        <a
        ...
        <br></br>
        <br></br>
        <span className="crc-terraform-text53">Tech Stack:</span>
        <br></br>
        <span>
