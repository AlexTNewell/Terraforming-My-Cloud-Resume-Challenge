...
import './dockerised-python-app.css'

const DockerisedPythonApp = (props) => {
  return (
    <div className="dockerised-python-app-container">
      <Helmet>
        <title>Dockerised-Python-App - Portfolio Page</title>
        <meta
          property="og:title"
          content="Dockerised-Python-App - Portfolio Page"
        />
      </Helmet>
      <div className="dockerised-python-app-container1">
        <div className="dockerised-python-app-container2">
          <h1 className="dockerised-python-app-text">Cloud Resume Challenge</h1>
        </div>
        <a
          href="https://github.com/AlexTNewell/Cloud-Resume-Challenge-CloudFormation"
          target="_blank"
          rel="noreferrer noopener"
          className="dockerised-python-app-link"
        >
          <img
            alt="image"
            src="/github-200h.png"
            className="dockerised-python-app-image"
          />
        </a>
      </div>
      <h2 className="dockerised-python-app-text01">Using Terraform</h2>
      <span className="dockerised-python-app-text02">
        <span>
        ...
        <br></br>
        <br></br>
        <span className="dockerised-python-app-text10">
          Frontend: Javascript, HTML, CSS
        </span>
        <br className="dockerised-python-app-text11"></br>
        <span className="dockerised-python-app-text12">
          Backend: Node.js, Python
        </span>
        <br className="dockerised-python-app-text13"></br>
        <span className="dockerised-python-app-text14">
          Database: DynamoDB / noSQL
        </span>
        <br className="dockerised-python-app-text15"></br>
        <span className="dockerised-python-app-text16">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer noopener"
          className="dockerised-python-app-link1"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer noopener"
          className="dockerised-python-app-link2"
        >
        ...
        <br></br>
        <br></br>
        <span className="dockerised-python-app-text53">Tech Stack:</span>
        <br></br>
        <span>
...
export default DockerisedPythonApp
