      ...
      <div className="steps-container">
        ...
        <div className="steps-step2">
          ...
          <div className="steps-container09">
            <h1 className="steps-text08">{props.heading2}</h1>
            <span className="steps-text09">
              <span>Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
              <br></br>
              <span></span>
            </span>
        ...
        <div className="steps-step3">
          ...
          <div className="steps-container12">
            <h1 className="steps-text12">
              <span>Deploy</span>
            </h1>
            <span className="steps-text14">
              <span>Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
              <br></br>
              <span></span>
            </span>
